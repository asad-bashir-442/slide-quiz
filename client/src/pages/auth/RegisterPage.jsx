        ...
        <motion.div {...fadeIn} className="flex flex-1 items-center justify-center">
            <div className="w-254.5 bg-base-200 p-6 rounded-lg max-[900px]:w-full my-4">
                <div className="text-center my-8 min-[900px]:hidden">
                    ...
                    <p className="opacity-60">Set up your profile to start building interactive quizzes for your presentations.</p>
                </div>

                <div className="flex items-center">
                    <form className="w-96 bg-base-100 p-8 shadow-2xl flex flex-col rounded-2xl max-[900px]:w-full" onSubmit={handleSubmit}>
                        ...
                        <fieldset className="fieldset">
                            <legend className="fieldset-legend text-base-content/70 text-lg">Password</legend>
                            <label className="input validator">
                    ...
                    <div className="mx-auto flex flex-col gap-5 max-[900px]:hidden">
                        ...
                        <p className="max-w-[48ch]">Set up your profile to start building interactive quizzes for your presentations.</p>
                        <Link to="/login">
                            <button className="btn btn-outline btn-secondary btn-wide btn-lg rounded-lg">Login</button>
                        </Link>
                    </div>
                </div>
            </div>
