    ...
    return (
        <div className="w-[80%] mx-auto mt-10 grid grid-cols-1 md:grid-cols-3 gap-10 items-center">
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="md:col-span-2 space-y-6">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight bg-linear-to-r bg-clip-text from-primary to-secondary text-transparent">Present. Ask. Interact.</h1>
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="flex justify-center">
                <img src="/images/preview.png" alt="Smartphone with a preview of the SlideQuiz Application" className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg rounded-xl" />
            </motion.div>

            <div className="col-span-full">
                <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl text-center mb-12 font-bold bg-linear-to-r bg-clip-text from-secondary to-primary text-transparent">SlideQuiz In Action</h2>
