        ...
        <>
            ...
            <dialog id="new_question_modal" className="modal">
                <div className="modal-box">
                    <h3 className="font-bold text-base-content/70 text-2xl">Create New Question</h3>
                    ...
                    <form onSubmit={handleSubmit} className="modal-action flex-col">
                        ...
                        <div>
                            <fieldset className="fieldset">
                                <legend className="fieldset-legend text-base-content/70 text-lg">Select Question Type</legend>
