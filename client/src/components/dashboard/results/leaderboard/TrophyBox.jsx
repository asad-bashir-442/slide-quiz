export function TrophyBox({ rank, name, score, percent }) {
    ...
    return (
        <div className="card card-side bg-base-300 shadow-md w-full max-w-2xl h-28">
            {/* Image */}
            <figure className="w-1/3 flex items-center justify-center bg-base-200">
                <div className="w-16 h-16 flex items-center justify-center">
                    <img src={imagePath} alt="Picture of a trophy" className="max-w-full max-h-full object-contain" />
                </div>
            </figure>
